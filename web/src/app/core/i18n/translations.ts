...
export const TRANSLATIONS = {
  en: {
    ...
    'clipboard.removeSkipped': 'Remove them',
    ...
    'files.savedTo': 'Saved to {path} on this phone.',
    'files.open': 'Open',
    'files.error.open': 'No app on this phone can open that file.',
  ...
  ar: {
    ...
    'clipboard.removeSkipped': 'احذفها',
    ...
    'files.dismiss': 'إخفاء',
    'files.savedTo': 'تم الحفظ في {path} على هذا الموبايل.',
    'files.open': 'فتح',
    'files.error.open': 'لا يوجد تطبيق على هذا الموبايل يفتح هذا الملف.',
